...
export default function PosScreen() {
    ...
    // ---- Caisse ouverte ?
    const { openRegister, loading: loadingRegister, refresh: refreshRegister } =
        useCashDashboard();
    ...
    // ---- Champs de paiement (dans le sheet)
                ...
                [
                    {
                        text: 'Voir',
                        onPress: () =>
                            navigation.navigate('Sales.Show', { id: res.sale_id }),
                    },
            ...
            {cartOpen ? (
                ...
                >
                    ...
                    <BottomSheetBody scrollable>
                        ...
                        <View style={{ gap: 8 }}>
                            {cart.map((line, index) => (
                                <View key={`${line.article_id}-${line.quantity_type}`} style={styles.line}>
            ...
            <View style={styles.productPrice}>
                ...
                {showUnitBtn ? (
                    <Text style={styles.productUnitPrice}>
                        Unité : {formatCurrency(resolveUnitPrice(article, 'UNIT'))}
                    </Text>
                ) : null}
            </View>
